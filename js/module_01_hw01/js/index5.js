 ...
 */
//const getAllNames = arr => arr.map( field => field['name']);
 ...
 */
// const getUsersByEyeColor = (arr, color) => arr.map( item => item['eyeColor'] === color ? `объект ${item['name']}`: null).filter(item => item != null);

// const getUsersByEyeColor = (arr, color) => arr.filter( item => item['eyeColor'] === color);
//
...
//  */
// const getUsersByGender = (arr, gender) => arr.map( item => item['gender'] === gender ? item['name']: null).filter(item => item != null);
//
...
//  *!/
// */
// const getInactiveUsers = arr => arr.filter(item => item['isActive'] === false).map(item => `Объект ${item['name']}`);

// const getInactiveUsers = arr => arr.filter(item => item['isActive'] === false);
...
const getUserByEmail = (arr, email) => arr.find(item => item['email'] === email);
...
//  *!/
const getUsersWithAge = (arr, min, max) => arr.filter(item => item['age']>min && item['age']<max);
...
//  *!/
const getTotalBalance = arr => arr.reduce((acc,item) => acc += item['balance'], 0 );
...
//  *!/
const getUsersByFriend = (arr, name) => arr.filter(item => item['friends'].some(elem => elem === name)).map(item => item['name']);
...
//---------------------------------------------------------------------------------------------
const getAllSkills = arr => arr.reduce((acc,item) => [...acc, ...item['skills']], '').sort().filter((item,index,array) => array[index] != array[index + 1]);
